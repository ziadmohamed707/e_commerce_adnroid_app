...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageTitle = findViewById(R.id.activity_reset_password_title);
    ...
    protected void onStart() {
        ...
        if (check.equals("settings")) {
            ...
            titleQuestions.setText("Please anser the following questions");
    ...
    private void verifyUser() {
        ...
        if (!phone.equals("") && !answer1.equals("") && !answer2.equals("")) {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        if (snapshot.hasChild("Security Questions")) {
                                ...
                                builder.setPositiveButton("Change", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (!newPassword.getText().toString().equals("")) {
                                            ...
                                            Toast.makeText(ResetPasswordActivity.this, "Please enter your password", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "You have not set the security quistions", Toast.LENGTH_SHORT).show();
                        }
            ...
            Toast.makeText(this, "Please Complete the phone", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void setAnswer() {
        ...
        if (question1.equals("") && question2.equals("")) {
            Toast.makeText(ResetPasswordActivity.this, "Please anser both questions.", Toast.LENGTH_SHORT).show();
        } else {
            DatabaseReference ref = FirebaseDatabase.getInstance()
                    .getReference()
                    .child("Users")
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ResetPasswordActivity.this, "you have answer questions successfully", Toast.LENGTH_SHORT).show();
